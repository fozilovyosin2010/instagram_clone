...
export const CustomToaster = ({
  ...
  return (
    <div
      className={clsx(
        "relative overflow-hidden rounded-lg bg-linear-to-tr text-[#fff] font-[600] flex justify-between items-center gap-4 p-[10px_15px] w-full max-w-[400px] shadow-2xl max-md:gap-1 max-md:p-1",
        type == "success"
    ...
    >
      <div
        className={clsx(
          "absolute -bottom-px left-[2px] right-[2px] w-full h-1 loader bg-[#fff]",
        )}
      ></div>
      {icon}
